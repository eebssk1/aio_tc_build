...
#export CFLAGS="-U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=1 -D__BUILD_NO_CON__ -flto-compression-level=1 -fprofile-partial-training -flto=2 -frandom-seed=1 -I/usr/local/include  @$CUR/gccflags -Wno-error=maybe-uninitialized"
