...
export CFLAGS="-U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=1 -Wa,-O2 -D__BUILD_NO_CON__ @$CUR/gccflags"
...
../configure --host=x86_64-w64-mingw32 --target=x86_64-w64-mingw32  --without-headers --without-crt --with-tools=all --prefix=$CUR/out || exit 255
...
../configure --prefix=$CUR/out --host=x86_64-w64-mingw32 --target=x86_64-w64-mingw32 --program-prefix=x86_64-w64-mingw32- --with-sysroot=$CUR/out/x86_64-w64-mingw32 --disable-shared --enable-multilib --enable-64-bit-bfd --enable-nls --disable-rpath --enable-install-libiberty --enable-plugins --enable-deterministic-archives --with-system-zlib --with-zstd --disable-werror --enable-lto --disable-gdb --disable-gdbserver --disable-gprof --disable-gprofng || exit 255
...
../configure --prefix=$CUR/out --host=x86_64-w64-mingw32 --target=x86_64-w64-mingw32 --program-prefix=x86_64-w64-mingw32- --enable-version-specific-runtime-libs --enable-checking=release --with-local-prefix=$CUR/out/x86_64-w64-mingw32/local  --with-arch=haswell --with-tune=skylake --enable-mingw-wildcard --with-gcc-major-version-only --disable-cet --disable-vtable-verify --enable-plugin  --enable-libatomic --enable-threads=posix --enable-graphite --enable-fully-dynamic-string --enable-tls --with-libstdcxx-zoneinfo="yes" --enable-libstdcxx-backtrace=yes --enable-libstdcxx-filesystem-ts --enable-libstdcxx-time --disable-libstdcxx-pch --enable-lto --enable-libgomp --disable-libssp --disable-libvtv --enable-shared=libgcc,libstdc++,libgomp,libatomic --enable-multiarch --enable-multilib --with-arch-32=haswell --with-multilib-list=m32,m64 --with-abi=m64 --disable-rpath --enable-nls --disable-werror --disable-symvers --disable-libstdcxx-debug --disable-win32-registry --enable-languages=c,c++,lto --disable-sjlj-exceptions --with-specs-file="$CUR/mingw64.specs" || exit 255
make -j$(($N+2)) all MAKEINFO=true || exit 255
